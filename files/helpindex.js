...
function showDialog(dataarr) {
  ...
  dialogtitle.innerHTML = "Choisissez un sujet";
  dialogcontent.className = "chm2webdialog";
  dialogmessage.innerHTML = "Veuillez sélectionner un sujet";
